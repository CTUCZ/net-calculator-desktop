...
class Ui_AppMainWindow(object):
    def setupUi(self, AppMainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(".\\logo_ctu _cz.gif"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        AppMainWindow.setWindowIcon(icon)
        ...
        self.nbr_avg.setLocale(QtCore.QLocale(QtCore.QLocale.Language.Czech, QtCore.QLocale.Country.Czechia))
        self.nbr_avg.setDecimals(1)
        self.nbr_avg.setMinimum(0.1)
        self.nbr_avg.setMaximum(1000000.0)
        self.nbr_avg.setSingleStep(0.1)
        self.nbr_avg.setStepType(QtWidgets.QAbstractSpinBox.StepType.DefaultStepType)
        ...
        self.nbr_max.setStyleSheet("")
        self.nbr_max.setLocale(QtCore.QLocale(QtCore.QLocale.Language.Czech, QtCore.QLocale.Country.Czechia))
        self.nbr_max.setDecimals(1)
        self.nbr_max.setMinimum(0.1)
        self.nbr_max.setMaximum(1000000.0)
        self.nbr_max.setSingleStep(0.1)
        self.nbr_max.setStepType(QtWidgets.QAbstractSpinBox.StepType.DefaultStepType)
        ...
        self.agg.setGeometry(QtCore.QRect(320, 160, 62, 22))
        ...
        self.capacity.setLocale(QtCore.QLocale(QtCore.QLocale.Language.Czech, QtCore.QLocale.Country.Czechia))
        self.capacity.setDecimals(1)
        self.capacity.setMinimum(0.1)
        self.capacity.setMaximum(1000000.0)
        self.capacity.setSingleStep(0.1)
        self.capacity.setStepType(QtWidgets.QAbstractSpinBox.StepType.DefaultStepType)
        ...
        self.probability = QtWidgets.QDoubleSpinBox(parent=self.section_C)
        self.probability.setGeometry(QtCore.QRect(320, 40, 91, 22))
        self.probability.setSizeIncrement(QtCore.QSize(0, 0))
        self.probability.setLocale(QtCore.QLocale(QtCore.QLocale.Language.Czech, QtCore.QLocale.Country.Czechia))
        self.probability.setDecimals(2)
        self.probability.setMinimum(0.01)
        self.probability.setMaximum(100.0)
        self.probability.setSingleStep(0.01)
        self.probability.setStepType(QtWidgets.QAbstractSpinBox.StepType.DefaultStepType)
        self.probability.setProperty("value", 90.0)
        ...
        self.probability_l_u.setGeometry(QtCore.QRect(420, 40, 41, 21))
        ...
        self.out_perf_UF_2 = QtWidgets.QLabel(parent=self.section_E)
        self.out_perf_UF_2.setGeometry(QtCore.QRect(530, 140, 61, 21))
        self.out_perf_UF_2.setObjectName("out_perf_UF_2")
        ...
        self.sdr_req.setStyleSheet("")
        self.sdr_req.setLocale(QtCore.QLocale(QtCore.QLocale.Language.Czech, QtCore.QLocale.Country.Czechia))
        self.sdr_req.setDecimals(1)
        self.sdr_req.setMinimum(0.1)
        self.sdr_req.setMaximum(1000000.0)
        self.sdr_req.setSingleStep(0.1)
        self.sdr_req.setStepType(QtWidgets.QAbstractSpinBox.StepType.DefaultStepType)
    ...
    def retranslateUi(self, AppMainWindow):
        ...
        self.out_perf_UF_2.setText(_translate("AppMainWindow", "% (s UF)"))
